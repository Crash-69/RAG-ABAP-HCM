...
FINAL_K = 15
BATCH_SIZE = 500
OUTPUT_DIR = Path(r"C:\Progetto_AI\RAG_V5_9_RESULTS")
CACHE_FILE = OUTPUT_DIR / "exact_cache_v5_9.pkl"
CACHE_VERSION = "5.7"
...
def exact(cache, p):
    ...
    for x in cache:
        ...
        # T12 / organizational functional lookup needs a dedicated lexical
        # candidate path: a relevant PA0001 SQL chunk may contain several
        # organizational fields without containing the natural-language
        # functional terms. Do not discard it before relationship ranking.
        org_candidate = False
        ...
        # Dedicated organizational candidate score for functional T12.
        if org_candidate:
            s += 12.0 * len(org_fields_found)
